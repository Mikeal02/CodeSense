              ...
              >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 sm:gap-3 max-w-2xl mx-auto mb-5 sm:mb-6 px-4 sm:px-0" data-onboarding="hero-input">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="h-13 sm:h-14 px-7 sm:px-8 gap-2 bg-primary text-primary-foreground hover:bg-primary/90 relative overflow-hidden group/btn rounded-xl font-semibold"
